...
public class PeerRetriever implements Callable<PeerRetriever> {
    ...
    static private Section handshakeRequest() {
        ...
        byte[] networkId = HexHelper.hexToBytes("1230f171610441611731008216a1a110"); // mainnet
        ...
        byte[] genesisHash =
                HexHelper.hexToBytes("418015bb9ae982a1975da7d79277c2705727a56894ba0fb246adaabb1f4632e3");
